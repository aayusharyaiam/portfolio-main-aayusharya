...
import { DoodleCircle, DoodleUnderline } from '@/components/motion/Doodles';
  ...
  return (
    <section id="about" className="py-24 px-6 overflow-hidden">
      <div className="max-w-6xl mx-auto">
        {/* Section Title */}
        <SectionTitle children="About Me" kicker="Personal Brand" />
        ...
        <div className="grid md:grid-cols-2 gap-10 md:gap-6">
          ...
          {/* Right: Education with subtle 3D depth (scale/tilt per scroll) */}
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className="border-l-[3px] border-marker-red pl-4">
                  ...
                  <p className="font-hand text-pencil/70 text-sm md:text-base">
                    Birla Institute of Technology, Mesra
                  </p>
                  <p className="font-hand text-pencil/50 text-xs md:text-sm">
                    (Patna Off-Campus)
                  </p>
                  <div className="flex items-center gap-2 mt-1">
                    <Calendar className="h-4 w-4 text-pen-blue" strokeWidth={2.5} />
                    <span className="font-hand text-xs md:text-sm text-pen-blue">
                      2024 – 2028
                    </span>
                  </div>
                </div>
                ...
                <div className="border-l-[3px] border-pen-blue pl-4">
                  ...
                  <p className="font-hand text-pencil/70 text-sm md:text-base">
                    D.A.V. Kapil Dev Public School, Ranchi
                  </p>
        ...
        <motion.div
          ...
          className="postit-card tape-decoration mt-12"
        >
          ...
          <p className="font-hand text-base md:text-lg text-pencil/80 leading-relaxed">
            <span className="text-3xl md:text-4xl font-kalam font-bold text-marker-red float-left mr-2 mt-1">
              M
            </span>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 mt-16">
          {[
            ...
            <motion.div
              ...
              style={{ borderRadius: stat.value === '100+' ? '58% 42% 35% 65% / 45% 55% 45% 55%' : stat.value === '6+' ? '73% 27% 70% 30% / 30% 56% 44% 70%' : stat.value === '2+' ? '30% 70% 42% 58% / 62% 28% 72% 38%' : '42% 58% 60% 40% / 35% 65% 32% 68%' }}
            >
